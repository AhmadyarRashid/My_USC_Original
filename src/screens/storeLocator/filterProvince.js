...
function FilterProvinceStoreScreen() {
        ...
        <ScrollView>
          <View style={styles.main}>
            <Dropdown
              ...
              defaultButtonText="Select Province | صوبہ منتخب کریں"
              data={zones
            ...
            <Dropdown
              ...
              defaultButtonText="Select District | ضلع منتخب کریں"
...
export default FilterProvinceStoreScreen;
