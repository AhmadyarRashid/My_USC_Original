      ...
      <ImageBackground
        ...
        <ScrollView>
          <View style={styles.main}>
            ...
            <View style={{height: 8}} />
            <Text style={styles.content}>
              2. اپنے مطلوبہ USC سٹور کو تلاش کرنے کے لیے فلٹرز لگائیں. زون،
              .علاقہ اور زمرہ
            </Text>
            ...
            <Text style={styles.content}>
              3. سبسڈی والی مصنوعات کی فہرست کھولنے کے لیے سبسڈی والی مصنوعات کا
              بٹن دبائیں ۔
            </Text>
            ...
            <Text style={styles.content}>
              4. دیگر مصنوعات کی فہرست کو کھولنے کے لیے دیگر مصنوعات کا بٹن
              دبائیں
            </Text>
            <TouchableOpacity
